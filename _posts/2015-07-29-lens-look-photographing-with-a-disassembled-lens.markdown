...
![]({{ page.asset_path }}/_DSC8089-1.jpg)
...
![Best selfie ever]({{ page.asset_path }}/back1.png)
...
![Extreme close-up! WHOOOOOAAAAAAAAAAAA!!!!]({{ page.asset_path }}/extreme-closeup-small.gif)
