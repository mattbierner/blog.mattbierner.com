...
## Counts
Given that much of *The Jungle* was published serially, it makes sense that each chapter has a fairly constant number of words.
...
Things start off at a reasonable 0.3% exclamation point rate, with one out of every 330 words an exclamation point, before spiking at chapter 15 and again at chapters 18 and 24. With text like this it's not hard to see why:
