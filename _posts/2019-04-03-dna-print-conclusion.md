...
After a month of printing, I finally opened the doors on a beautiful clear blue sky Sunday afternoon so that people could experience the printed genome and see the punches in action. I even decorated the place to reduce the sketchiness of the warehouse setting and guide visitors to the print room on the second story.
...
{% include image.html file="guide-stairs.jpg" description="These stairs were very safe. I only fell through them once, only a little bit at that" %}
