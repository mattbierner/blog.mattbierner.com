...
I then combined these images into a video. It's 43 hours long, which is just about the time driving all of I-80 would take. This video is projected on the ceiling using a small projector. The projector runs the video on a loop, crossing the United States from east to west, turning back to go west to east, and so on and so on.
