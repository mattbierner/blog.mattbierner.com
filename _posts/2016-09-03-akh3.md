...
links:
  - title: "Source"
    url: "https://github.com/mattbierner/akh"
  - title: "Documentation"
    url: "https://github.com/mattbierner/akh#overview"
---
...
The core [`akh` npm package](https://www.npmjs.com/package/akh) still wraps up all your favorite types, such as `Either` and `Cont`, but you can now also consume those types through individual npm packages:
