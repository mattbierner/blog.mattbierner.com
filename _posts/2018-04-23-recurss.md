...
links:
  - title: "Site"
    url: "https://recurss.github.io"
  - title: "Submit a new specimen"
    url: "https://github.com/recurss/recurss.github.io#submitting"
---

{% include image.html file="title.png" description="200 nested divs" %}

[Recurss][site] is a collection of recursive css specimens. These work by styling a page consisting of nothing but nested divs:
...
My first brush with recursive css was writing the [Blot're 404 page](https://blot.re/not-found). I really like the technique because its limitations make you think about styling in a different way. Just mucking around with values and properties to see what happens is also just a lot of fun (it's also a good way to stress test your browser).
