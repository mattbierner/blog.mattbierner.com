...
links:
  - title: "Get Face Drop"
    url: "https://apps.apple.com/us/app/face-drop-ar/id1569124225"
---
...
- Support for all iOS devices.
    ...
    Face Drop now runs on all iOS devices. If your device does not have a TrueDepth camera, you can capture 2D selfies and place them in the world (users with a TrueDepth camera can also switch between 2D and 3D capture modes)
