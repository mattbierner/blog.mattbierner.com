...
Furthermore, take an already shitty endoscope camera and point it at an even shittier mirror (I swear that thing is little more than cardboard covered in silver Sharpie) and the result is not pretty. Even outside the mouth, the image quality is poor at best, and, once inside, the mirror fogs up at the merest exhale. The mirror doesn't even cover the entire view.
